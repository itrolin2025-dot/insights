...
<style>
    ...
    @media (max-width: 1024px) {
        ...
        .sidebar.sidebar-mobile-open {
            ...
            opacity: 1;
            pointer-events: all;
            z-index: 80; /* Above overlay (z-70) so sidebar is visible when open */
        }
        /* Overlay visibility controlled by JS only - do NOT force display:block here */
    }
...
<div class="flex flex-col lg:flex-row min-h-screen">
    ...
    <script>
        ...
        function closeSidebar() {
            ...
            var headerBurger = document.getElementById('sidebarBurgerBtnHeader');
            if (headerBurger) headerBurger.classList.remove('open');
            overlay.style.opacity = "0";
            setTimeout(()=>{overlay.style.display="none";}, 170);
            document.body.style.overflow = '';
        }
