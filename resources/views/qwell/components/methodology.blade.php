...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-5">
    <div class="bg-white rounded-xl shadow-lg p-8 sm:p-12 lg:p-16 space-y-12">
        ...
        <div class="text-xl text-gray-700 leading-[2.05] space-y-12">
            ...
            <div class="mb-8">
                <h3 class="text-2xl font-bold text-[#0B6E99] mb-4">Our Guiding Philosophy</h3>
                <p class="mb-5">
                ...
                <ul class="list-disc list-inside text-left mt-4 ml-6 space-y-2">
            ...
            <div class="mb-8">
                <h3 class="text-2xl font-bold text-[#0B6E99] mb-4">How We Do It</h3>
                <p class="mb-5">
                ...
                <ol class="list-decimal list-inside text-left mt-4 ml-6 space-y-2">
                ...
                <p class="mt-4">Every insight is built on the last—no shortcuts or contradictions allowed.</p>
            </div>

            <div class="mb-8">
                <h3 class="text-2xl font-bold text-[#0B6E99] mb-4">Where Our Data Comes From</h3>
                <p class="mb-5">
                ...
                <p class="mt-4 text-gray-500 italic">No unverified blogs or influencer chatter—only credible facts make the cut.</p>
            </div>

            <div class="mb-8">
                <h3 class="text-2xl font-bold text-[#0B6E99] mb-4">The Multi-Lens Advantage</h3>
                <p class="mb-5">
                ...
                <p class="mt-4">No single perspective dominates—complexity is embraced, not ignored.</p>
            </div>
            
            <div class="mb-8">
                <h3 class="text-2xl font-bold text-[#0B6E99] mb-4">Keeping It Honest</h3>
                <p class="mb-5">
                ...
                <p class="mt-4">Q’WELL features as context—not as the answer.</p>
            </div>
            
            <div>
                <h3 class="text-2xl font-bold text-[#0B6E99] mb-4">Deliverables You Can Trust</h3>
                <ul class="list-disc list-inside text-left mt-4 ml-6 space-y-2">
                ...
                <p class="mt-4">In short: Every insight is earned, never assumed—so you can take action with confidence.</p>
            </div>
        </div>
    </div>
</main>
